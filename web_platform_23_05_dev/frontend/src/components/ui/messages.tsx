        ...
        return (
            ...
            >
                ...
                >
                    <div
                        className={
                            "card-header bg-success bg-opacity-25 lead text-white m-0 p-1"
                        }
                    >
                        успешно
                    </div>
        ...
        return (
            ...
            >
                ...
                >
                    <div
                        className={
                            "card-header bg-danger bg-opacity-25 lead text-white m-0 p-1"
                        }
                    >
                        внимание!
                    </div>
        ...
        return (
            ...
            >
                ...
                >
                    <div
                        className={
                            "card-header bg-warning bg-opacity-25 lead text-white m-0 p-1"
                        }
                    >
                        внимание!
                    </div>
        ...
        return (
            ...
            >
                ...
                >
                    <div
                        className={
                            "card-header bg-secondary bg-opacity-25 lead text-white m-0 p-1"
                        }
                    >
                        информация
                    </div>
